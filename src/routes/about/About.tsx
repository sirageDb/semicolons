        ...
        <div className={styles.contentText}>
          <div className={styles.section}>
            ...
            <p className={styles.sectionExplanation}>
              ...
              solutions to existing problems using the power i have as a developer, also developing the DEV community by
              sharing my knowledge, writing posts, and sharing my opensource projects.{" "}
            </p>
          </div>
          <div className={styles.section}>
            <span className={styles.sectionTitle}>Why semicolons</span>
            <p className={styles.sectionExplanation}>
              At the begining i named this website iLoveSemiColon, because obviously as a former C++ programmer i am so
              attached to semicolons, but then it was time for a better name and i got the idea to simply name it
              Semicolons :)
            </p>
          </div>
          <div className={styles.section}>
            ...
            <p className={styles.sectionExplanation}>
              Nope, as i said i already work at KOLABS, Semicolons is not a company, nor a web agency, it is only my dev
              blog where i can share with others my experience and knowledge.
            </p>
          </div>
        </div>
      </div>
